...
public class GetImagePageUrlApi {
    ...
    public static String getImagePageUrl(String imageUrl) {
        ...
        formData.put("image_source", "PC_UPLOAD_IMAGE_MOVE");
        // 获取当前时间戳
    ...
    public static void main(String[] args) {
        // 测试以图搜图功能
        String imageUrl = "https://luli-1319967679.cos.ap-guangzhou.myqcloud.com/space/4/2025-01-26_7uVwWUy8uX45b58y.webp";
