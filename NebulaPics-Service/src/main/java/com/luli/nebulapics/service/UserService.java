...
public interface UserService extends IService<User> {
     ...
     * @return 新用户 id
     */
    long userRegister(String userAccount, String code, String userPassword, String checkPassword);
     ...
     * @return 脱敏后的用户信息
     */
    LoginUserVO userLogin(String userAccount, String userPassword, String captcha,HttpServletRequest request);
